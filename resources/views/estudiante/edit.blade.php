<div class="modal fade modal-lg" id="modalEdit{{ $estudiante->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fs-5 color fw-2 mt-2" id="modalTitleId">Editar Informacion Del Estudiante <i
                        class="bi bi-person"></i> </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="POST" class="needs-validation" action="{{ route('estudiantes.update', $estudiante->user->id) }}"
                    ...
                    <div class="container-fluid row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control border-2 shadow-sm" name="name" id="name"
                                required value="{{ $estudiante->user->name }}">
                            @if ($errors->has('name'))
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control border-2 shadow-sm" name="email" id="email"
                                required value="{{ $estudiante->user->email }}">
                            @if ($errors->has('email'))
                                <small class="text-danger fw-semibold">
                                    <i class="bi bi-exclamation-circle"></i>
                                </small>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control border-2 shadow-sm" name="identificacion"
                                id="identificacion" required value="{{ $estudiante->identificacion }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control border-2 shadow-sm" name="telefono" required
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control border-2 shadow-sm" name="direccion"
                                id="direccion" required value="{{ $estudiante->direccion }}">
                        ...
                        <div class="col-12 mb-4" style="margin-top: 10px">
                            ...
                            <select class="form-select border-2 shadow-sm" id="curso_id" name="curso_id" required>
                                <option value="{{ $estudiante->curso->id }}">{{ $estudiante->curso->nombre }}</option>
                                @foreach ($cursos as $curso)
                                    @if ($curso->id !== $estudiante->curso->id)
