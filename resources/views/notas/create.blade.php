<div class="modal fade modal-lg" id="createNota" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" class="needs-validation" action="{{ route('notas.create') }}" novalidate
                role="form">
                @csrf
                <div class="modal-body">
                    <div class="container-fluid row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control border-2 shadow-sm" name="observaciones" id="observaciones" rows="2"></textarea>
                        </div>
                    </div>
